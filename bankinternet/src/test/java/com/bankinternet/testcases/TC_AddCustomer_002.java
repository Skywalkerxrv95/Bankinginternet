...
import com.bankinternet.pageobjects.Com_AddCustomer;
...
public class TC_AddCustomer_002 extends Baseclass {
	...
	public void addNewCustomer(String name ,String cgender, String dd,String mm,String yy,String caddress,String ccity,
			String cstate,String cpinno,String ctelephoneno,String cemailid,String cpassword) throws InterruptedException {
		

		
		
		Com_AddCustomer ad=new Com_AddCustomer(driver);
